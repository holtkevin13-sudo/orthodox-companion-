...
const PLAN_WISDOM = [
  ...
  { ot: { ref: "Job 38–42", book: "JOB", ch: 38 }, note: "The voice from the whirlwind; where were you when I laid the foundations?" },
  ...
  { ot: { ref: "Prov 16–20", book: "PRO", ch: 16 }, note: "The plans of the heart belong to man; the Lord weighs the spirit" },
  ...
  { ot: { ref: "Prov 21–25", book: "PRO", ch: 21 }, note: "Train up a child in the way he should go; do not remove the ancient landmark" },

  // Day 13 — The words of Agur: I am the most ignorant of men
  // Who can find a virtuous woman? Her worth is far above rubies
  { ot: { ref: "Prov 26–31", book: "PRO", ch: 26 }, note: "The words of Agur: I am the most ignorant of men" },
  ...
  { ot: { ref: "Eccl 7–12", book: "ECC", ch: 7 }, note: "A good name is better than precious ointment; there is no partiality with God" },
  ...
  { ot: { ref: "Song 1–8", book: "SNG", ch: 1 }, note: "The great love poem of Scripture; the soul's longing for union with God" },
  ...
  { ot: { ref: "Wis 1–6", book: "WIS", ch: 1 }, note: "Love righteousness; the souls of the righteous are in God's hand" },
  ...
  { ot: { ref: "Wis 7–12", book: "WIS", ch: 7 }, note: "Solomon's prayer for wisdom; wisdom in the history of Israel" },
  ...
  { ot: { ref: "Wis 13–19", book: "WIS", ch: 13 }, note: "The folly of idolatry; God's mercy shown through the Exodus" },
  ...
  { ot: { ref: "Sir 1–5", book: "SIR", ch: 1 }, note: "Wisdom comes from the Lord; fear of the Lord is glory and gladness" },

  // Day 21 — Do not be ashamed of wisdom; friendship and faithful counsel
  // The discipline of the tongue; diligence in your calling
  { ot: { ref: "Sir 6–10", book: "SIR", ch: 6 }, note: "Do not be ashamed of wisdom; friendship and faithful counsel" },
  ...
  { ot: { ref: "Sir 11–15", book: "SIR", ch: 11 }, note: "Give to the poor without grudging; examine yourself before judging" },

  // Day 23 — God sees all; the wonders of creation testify to the Creator
  // A physician's work is from God; honor the doctor
  { ot: { ref: "Sir 16–20", book: "SIR", ch: 16 }, note: "God sees all; the wonders of creation testify to the Creator" },

  // Day 24 — Reproving a friend; the danger of the tongue; the bee and Lady Wisdom
  // Do not be ashamed to confess your sins
  { ot: { ref: "Sir 21–25", book: "SIR", ch: 21 }, note: "Reproving a friend; the danger of the tongue; the bee and Lady Wisdom" },
  ...
  { ot: { ref: "Sir 26–30", book: "SIR", ch: 26 }, note: "A good wife is a great gift; wisdom in household management" },
  ...
  { ot: { ref: "Sir 31–35", book: "SIR", ch: 31 }, note: "Rich and poor before God; table manners and feasting rightly" },
  ...
  { ot: { ref: "Sir 36–39", book: "SIR", ch: 36 }, note: "Prayer for the people of God; gather all the tribes of Jacob" },

  // Day 28 — The joys and sorrows of life; the wonders of God in nature
  // Thunder, lightning, snow, and hail proclaim His glory
  { ot: { ref: "Sir 40–43", book: "SIR", ch: 40 }, note: "The joys and sorrows of life; the wonders of God in nature" },
  ...
  { ot: { ref: "Sir 48–51", book: "SIR", ch: 48 }, note: "Hezekiah, Isaiah, Josiah, Zerubbabel, Nehemiah; the final exhortation" },
];
