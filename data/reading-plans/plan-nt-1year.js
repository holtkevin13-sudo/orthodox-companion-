...
const PLAN_NT_1YEAR = [
  ...
  // Day 3 — Reflection
  { ps: { ref: "Ps 1", ch: 1 }, note: "Reflection" },
  // Day 4
  { nt: { ref: "Mt 3", book: "MAT", ch: 3 } },
  // Day 5
  { nt: { ref: "Mt 4", book: "MAT", ch: 4 } },
  // Day 6 — Reflection
  { ps: { ref: "Ps 5", ch: 5 }, note: "Reflection" },
  // Day 7
  ...
  // Day 10 — Reflection
  { ps: { ref: "Ps 8", ch: 8 }, note: "Reflection" },
  // Day 11
  ...
  // Day 14 — Reflection
  { ps: { ref: "Ps 19", ch: 19 }, note: "Reflection" },
  // Day 15
  ...
  // Day 18 — Reflection
  { ps: { ref: "Ps 22", ch: 22 }, note: "Reflection" },
  // Day 19
  { nt: { ref: "Mt 14", book: "MAT", ch: 14 } },
  // Day 20
  { nt: { ref: "Mt 15", book: "MAT", ch: 15 } },
  // Day 21 — Reflection
  { ps: { ref: "Ps 23", ch: 23 }, note: "Reflection" },
  // Day 22
  ...
  // Day 25 — Reflection
  { ps: { ref: "Ps 24", ch: 24 }, note: "Reflection" },
  // Day 26
  ...
  // Day 29 — Reflection
  { ps: { ref: "Ps 27", ch: 27 }, note: "Reflection" },
  // Day 30
  ...
  // Day 44 — Reflection
  { ps: { ref: "Ps 42", ch: 42 }, note: "Reflection" },
  // Day 45
  ...
  // Day 49 — Reflection
  { ps: { ref: "Ps 51", ch: 51 }, note: "Reflection" },
  // Day 50
  ...
  // Day 54 — Reflection
  { ps: { ref: "Ps 63", ch: 63 }, note: "Reflection" },
  // Day 55
  ...
  // Day 59 — Reflection
  { ps: { ref: "Ps 91", ch: 91 }, note: "Reflection" },
  ...
  // Day 62 — Reflection
  { ps: { ref: "Ps 25", ch: 25 }, note: "Reflection" },
  // Day 63
  ...
  // Day 68 — Reflection
  { ps: { ref: "Ps 40", ch: 40 }, note: "Reflection" },
  // Day 69
  ...
  // Day 77 — Reflection
  { ps: { ref: "Ps 84", ch: 84 }, note: "Reflection" },
  // Day 78
  { nt: { ref: "Lk 13", book: "LUK", ch: 13 } },
  // Day 79
  { nt: { ref: "Lk 14", book: "LUK", ch: 14 } },
  // Day 80 — Reflection
  { ps: { ref: "Ps 90", ch: 90 }, note: "Reflection" },
  // Day 81
  ...
  // Day 102 — Reflection
  { ps: { ref: "Ps 36", ch: 36 }, note: "Reflection" },
  // Day 103
  ...
  // Day 121 — Reflection
  { ps: { ref: "Ps 130", ch: 130 }, note: "Reflection" },
  // Day 122
  ...
  // Day 126 — Reflection
  { ps: { ref: "Ps 2", ch: 2 }, note: "Reflection" },
  // Day 127
  ...
  // Day 134 — Reflection
  { ps: { ref: "Ps 47", ch: 47 }, note: "Reflection" },
  // Day 135
  ...
  // Day 138 — Reflection
  { ps: { ref: "Ps 66", ch: 66 }, note: "Reflection" },
  // Day 139
  ...
  // Day 142 — Reflection
  { ps: { ref: "Ps 68", ch: 68 }, note: "Reflection" },
  // Day 143
  { nt: { ref: "Acts 16", book: "ACT", ch: 16 } },
  // Day 144
  { nt: { ref: "Acts 17", book: "ACT", ch: 17 } },
  // Day 145 — Reflection
  { ps: { ref: "Ps 96", ch: 96 }, note: "Reflection" },
  // Day 146
  ...
  // Day 149 — Reflection
  { ps: { ref: "Ps 98", ch: 98 }, note: "Reflection" },
  // Day 150
  ...
  // Day 157 — Reflection
  { ps: { ref: "Ps 104", ch: 104 }, note: "Reflection" },
  // Day 158
  ...
  { ps: { ref: "Ps 118", ch: 118 }, note: "Reflection" },
  // Day 161 — Reflection
  { ps: { ref: "Ps 150", ch: 150 }, note: "Reflection" },
  ...
  // Day 177 — Reflection
  { ps: { ref: "Ps 32", ch: 32 }, note: "Reflection" },
  // Day 178
  ...
  { ps: { ref: "Ps 51", ch: 51 }, note: "Reflection" },
  // Day 184 — Reflection
  { ps: { ref: "Ps 62", ch: 62 }, note: "Reflection" },
  // Day 185 — Reflection
  { ps: { ref: "Ps 103", ch: 103 }, note: "Reflection" },
  ...
  { ps: { ref: "Ps 118", ch: 118 }, note: "Reflection" },
  // Day 209 — Reflection
  { ps: { ref: "Ps 148", ch: 148 }, note: "Reflection" },
  ...
  // Day 229 — Reflection
  { ps: { ref: "Ps 119", ch: 119 }, note: "Reflection" },
  // Day 230
  ...
  // Day 268 — Reflection
  { ps: { ref: "Ps 15", ch: 15 }, note: "Reflection" },
  // Day 269
  ...
  { nt: { ref: "Phlm", book: "PHM", ch: 1 }, note: "Receive him no longer as a slave but as a dear brother" },
  ...
  { ps: { ref: "Ps 40", ch: 40 }, note: "Reflection" },
  // Day 298 — Reflection
  { ps: { ref: "Ps 45", ch: 45 }, note: "Reflection" },
  // Day 299
  ...
  { ps: { ref: "Ps 91", ch: 91 }, note: "Reflection" },
  // Day 302 — Reflection
  { ps: { ref: "Ps 110", ch: 110 }, note: "Reflection" },
  // Day 303 — Reflection
  { ps: { ref: "Ps 118", ch: 118 }, note: "Reflection" },
  ...
  // Day 355 — Reflection
  { ps: { ref: "Ps 93", ch: 93 }, note: "Reflection" },
  // Day 356
  ...
  { ps: { ref: "Ps 150", ch: 150 }, note: "Final Reflection: Let everything that has breath praise the Lord" },
];
...
// ─────────────────────────────────────────────────────────────────────────
const PLAN_NT_1YEAR_META = {
  id:           "nt-1yr",
  globalVar:    "PLAN_NT_1YEAR",
  metaVar:      "PLAN_NT_1YEAR_META",
  title:        "The New Testament — 1 Year",
  durationLine: "365 days · The New Covenant",
  pdfFilename:  "orthodox-companion-the-new-testament-one-year.pdf",
  viewSlug:     "new-testament-one-year",
  audience:     ["Inquirer", "Catechumen", "The Faithful"],
  summary:      "The whole New Testament read across one year, slowly enough to dwell on each Gospel, each Epistle, each chapter, with the Psalms threaded through as the prayer of the Church. Roughly one chapter daily, with time to read again, to ask, to pray. Well-suited to inquirers reading the New Testament for the first time, to catechumens preparing for baptism, and to the faithful returning to the apostolic witness with fresh attention.",
  description:  "The New Testament read at a gentle pace, with Psalm reflections throughout.",
  sections:     {
    1: "MATTHEW",
    40: "MARK",
    60: "LUKE",
