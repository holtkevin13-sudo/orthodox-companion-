...
const PLAN_CATECHUMEN = [
  ...
  { nt: { ref: "Acts 1", book: "ACT", ch: 1 }, ot: { ref: "Wis 1", book: "WIS", ch: 1 } },

  // Day 23 — Pentecost; Peter's first sermon; three thousand baptized
  { nt: { ref: "Acts 2", book: "ACT", ch: 2 }, ot: { ref: "Wis 2", book: "WIS", ch: 2 } },

  // Day 24 — The lame man healed; Peter in Solomon's Portico
  { nt: { ref: "Acts 3", book: "ACT", ch: 3 }, ot: { ref: "Wis 3", book: "WIS", ch: 3 } },

  // Day 25 — Peter and John before the Sanhedrin; the Church prays boldly
  { nt: { ref: "Acts 4", book: "ACT", ch: 4 }, ot: { ref: "Wis 4", book: "WIS", ch: 4 } },

  // Day 26 — Ananias and Sapphira; Gamaliel's counsel
  { nt: { ref: "Acts 5", book: "ACT", ch: 5 }, ot: { ref: "Wis 5", book: "WIS", ch: 5 } },

  // Day 27 — The seven deacons ordained; Stephen's ministry begins
  { nt: { ref: "Acts 6", book: "ACT", ch: 6 }, ot: { ref: "Wis 6", book: "WIS", ch: 6 } },

  // Day 28 — Stephen's great speech; the first martyr
  { nt: { ref: "Acts 7", book: "ACT", ch: 7 }, ot: { ref: "Wis 7", book: "WIS", ch: 7 } },

  // Day 29 — Philip in Samaria; Simon Magus; the Ethiopian eunuch baptized
  { nt: { ref: "Acts 8", book: "ACT", ch: 8 }, ot: { ref: "Wis 8", book: "WIS", ch: 8 } },

  // Day 30 — Saul's conversion on the road to Damascus
  { nt: { ref: "Acts 9", book: "ACT", ch: 9 }, ot: { ref: "Wis 9", book: "WIS", ch: 9 } },

  // Day 31 — Cornelius; Peter's vision; Gentiles receive the Spirit
  { nt: { ref: "Acts 10–11", book: "ACT", ch: 10 }, ot: { ref: "Wis 10", book: "WIS", ch: 10 } },

  // Day 32 — Herod's persecution; James martyred; Peter freed by an angel
  { nt: { ref: "Acts 12–13", book: "ACT", ch: 12 }, ot: { ref: "Wis 11", book: "WIS", ch: 11 } },

  // Day 33 — First missionary journey continues; the Council at Jerusalem
  { nt: { ref: "Acts 14–15", book: "ACT", ch: 14 }, ot: { ref: "Wis 12", book: "WIS", ch: 12 } },

  // Day 34 — Timothy joins; Macedonia; Lydia baptized; Paul in prison
  { nt: { ref: "Acts 16–17", book: "ACT", ch: 16 }, ot: { ref: "Wis 13", book: "WIS", ch: 13 } },

  // Day 35 — Corinth; Apollos; Paul's third journey begins
  { nt: { ref: "Acts 18–19", book: "ACT", ch: 18 }, ot: { ref: "Wis 14", book: "WIS", ch: 14 } },

  // Day 36 — Paul's farewell to the elders at Ephesus; Jerusalem bound
  { nt: { ref: "Acts 20–21", book: "ACT", ch: 20 }, ot: { ref: "Wis 15", book: "WIS", ch: 15 } },

  // Day 37 — Paul arrested; his defense before the crowd and Sanhedrin
  { nt: { ref: "Acts 22–23", book: "ACT", ch: 22 }, ot: { ref: "Wis 16", book: "WIS", ch: 16 } },

  // Day 38 — Paul before Felix and Festus
  { nt: { ref: "Acts 24–25", book: "ACT", ch: 24 }, ot: { ref: "Wis 17", book: "WIS", ch: 17 } },

  // Day 39 — Paul before Agrippa; the voyage and shipwreck
  { nt: { ref: "Acts 26–27", book: "ACT", ch: 26 }, ot: { ref: "Wis 18", book: "WIS", ch: 18 } },

  // Day 40 — Paul arrives in Rome; the Gospel reaches the ends of the earth
  { nt: { ref: "Acts 28", book: "ACT", ch: 28 }, ot: { ref: "Wis 19", book: "WIS", ch: 19 } },
];
