...
// ─────────────────────────────────────────────────────────────────────────
const PLAN_OT_1YEAR_META = {
  id:           "ot-1yr",
  globalVar:    "PLAN_OT_1YEAR",
  metaVar:      "PLAN_OT_1YEAR_META",
  title:        "The Old Testament — 1 Year",
  durationLine: "365 days · The Septuagint",
  pdfFilename:  "orthodox-companion-the-old-testament-one-year.pdf",
  viewSlug:     "old-testament-one-year",
  audience:     ["Inquirer", "The Faithful"],
  summary:      "The complete Old Testament read in one year, in the order of the Septuagint, with the Deuterocanonical books — Tobit, Judith, Wisdom, Sirach, Baruch, the Maccabees, and others — read alongside the books of the Hebrew canon. The plan moves through the Pentateuch, the historical books, the wisdom literature, and the prophets, roughly three chapters daily. Well-suited to the faithful who want to know the Scriptures of the Church in their fullness, and to inquirers who already know the New Testament and wish to discover its roots in the prophets and the patriarchs.",
  description:  "The full Orthodox Old Testament in LXX order, including all deuterocanonicals.",
  sections:     {
    1: "PENTATEUCH",
    64: "HISTORICAL BOOKS",
