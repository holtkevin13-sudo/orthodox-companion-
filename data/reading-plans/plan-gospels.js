...
const PLAN_GOSPELS = [
  ...
  { nt: { ref: "Mt 12", book: "MAT", ch: 12 }, note: "Woes on the cities; Come to me, all you who are weary · The Sabbath controversy; the Pharisees blaspheme; Jonah's sign" },
  ...
  { nt: { ref: "Mt 13–14", book: "MAT", ch: 13 }, note: "Parables of the Kingdom: the Sower, Tares, Mustard Seed, Pearl · John the Baptist beheaded; the feeding of the five thousand" },
  ...
  { nt: { ref: "Mt 15–16", book: "MAT", ch: 15 }, note: "Traditions of the elders; the Canaanite woman; feeding of the four thousand · The demand for a sign; the leaven of the Pharisees; Peter's confession at Caesarea Philippi" },
  ...
  { nt: { ref: "Mt 17–18", book: "MAT", ch: 17 }, note: "The Transfiguration; healing the epileptic boy; the Temple tax · Greatness in the Kingdom; the lost sheep; forgiveness seventy times seven" },
  ...
  { nt: { ref: "Mt 19–20", book: "MAT", ch: 19 }, note: "Marriage and divorce; the rich young ruler; the first shall be last · The triumphal entry; the cleansing of the Temple; the cursing of the fig tree" },
  ...
  { nt: { ref: "Mt 21–22", book: "MAT", ch: 21 }, note: "The parable of the two sons; the wicked tenants; the wedding banquet · Render to Caesar; the greatest commandment; David's son" },

  // Day 17 — The seven woes against the scribes and Pharisees
  // The Olivet Discourse: signs of the end; the faithful servant
  { nt: { ref: "Mt 23–24", book: "MAT", ch: 23 }, note: "The seven woes against the scribes and Pharisees · The Olivet Discourse: signs of the end; the faithful servant" },
  ...
  { nt: { ref: "Mt 25–28", book: "MAT", ch: 25 }, note: "Parables: the ten virgins, the talents; the judgment of the nations · The Last Supper; Gethsemane; the betrayal; the trial; the denial · The crucifixion; the burial; the Resurrection; the Great Commission" },
  ...
  { nt: { ref: "Mk 2–3", book: "MRK", ch: 2 }, note: "The paralytic lowered through the roof; Levi called; new wine in new wineskins · The man with the withered hand; the Twelve named; the Beelzebul controversy" },
  ...
  { nt: { ref: "Mk 4–5", book: "MRK", ch: 4 }, note: "The Sower; the lamp under the bushel; the storm stilled · The Gerasene demoniac; Jairus's daughter; the woman with the hemorrhage" },
  ...
  { nt: { ref: "Mk 6–7", book: "MRK", ch: 6 }, note: "The rejection at Nazareth; the mission of the Twelve; Herod and the Baptist · Walking on water; the Syrophoenician woman; the deaf-mute healed" },
  ...
  { nt: { ref: "Mk 8–9", book: "MRK", ch: 8 }, note: "The Pharisees demand a sign; the leaven of the Pharisees · Peter's confession; the first Passion prediction; the Transfiguration · The healing at the foot of the mountain; a second Passion prediction" },
  ...
  { nt: { ref: "Mk 10–11", book: "MRK", ch: 10 }, note: "Marriage and divorce; the rich young ruler; a third Passion prediction · Blind Bartimaeus; the triumphal entry; the cleansing of the Temple" },

  // Day 25 — The wicked tenants; render to Caesar; the greatest commandment
  // The Olivet Discourse: watch and be ready
  { nt: { ref: "Mk 12–13", book: "MRK", ch: 12 }, note: "The wicked tenants; render to Caesar; the greatest commandment · The Olivet Discourse: watch and be ready" },
  ...
  { nt: { ref: "Lk 8–9", book: "LUK", ch: 8 }, note: "The women who followed Jesus; the Sower; the stilling of the storm · Jairus's daughter; the mission of the Twelve; the feeding of the five thousand; Peter's confession" },
  ...
  { nt: { ref: "Lk 10–11", book: "LUK", ch: 10 }, note: "The seventy sent out; the Good Samaritan; Mary and Martha · The Lord's Prayer; the friend at midnight; ask, seek, knock; woes to the Pharisees" },
  ...
  { nt: { ref: "Lk 12–13", book: "LUK", ch: 12 }, note: "Fear not; the rich fool; watch and be ready; division and discernment · The call to repentance; the mustard seed; the narrow door; lament over Jerusalem" },

  // Day 38 — The great banquet; counting the cost; the lost sheep, coin, and sons
  // The dishonest steward; Lazarus and the rich man
  { nt: { ref: "Lk 14–16", book: "LUK", ch: 14 }, note: "The great banquet; counting the cost; the lost sheep, coin, and sons · The dishonest steward; Lazarus and the rich man" },
  ...
  { nt: { ref: "Lk 17–18", book: "LUK", ch: 17 }, note: "Forgiveness and faith; the ten lepers; the Kingdom does not come with observation · The persistent widow; the Pharisee and the tax collector; the rich young ruler" },
  ...
  { nt: { ref: "Lk 19–20", book: "LUK", ch: 19 }, note: "Zacchaeus; the parable of the minas; the triumphal entry; weeping over Jerusalem · The cleansing of the Temple; the wicked tenants; render to Caesar" },
  ...
  { nt: { ref: "Jn 13–14", book: "JHN", ch: 13 }, note: "The washing of feet; the new commandment; the betrayal foretold · I am the way, the truth, and the life; the promise of the Paraclete" },

  // Day 57 — I am the true vine; abide in my love; the hatred of the world
  // The Paraclete convicts the world; sorrow turns to joy
  { nt: { ref: "Jn 15–16", book: "JHN", ch: 15 }, note: "I am the true vine; abide in my love; the hatred of the world · The Paraclete convicts the world; sorrow turns to joy" },
  ...
  { nt: { ref: "Jn 18–19", book: "JHN", ch: 18 }, note: "The arrest; Annas and Caiaphas; Peter's denial; Pilate: I find no fault in him · The crucifixion; It is finished; the burial" },
...
// ─────────────────────────────────────────────────────────────────────────
const PLAN_GOSPELS_META = {
  id:           "gospels-60",
  globalVar:    "PLAN_GOSPELS",
  metaVar:      "PLAN_GOSPELS_META",
  title:        "The Four Gospels",
  durationLine: "60 days · The four Gospels",
  pdfFilename:  "orthodox-companion-the-four-gospels.pdf",
  viewSlug:     "four-gospels",
  audience:     ["Inquirer", "Catechumen", "The Faithful"],
  summary:      "All four Gospels read in canonical order — Matthew, Mark, Luke, and John — over two months. The pace is roughly one chapter daily, slow enough to walk with our Lord through His earthly ministry, His Passion, and His Resurrection. Well-suited to inquirers encountering Christ in the witness of the apostles for the first time, and to the faithful returning to the Gospels with fresh attention. A short note accompanies each day to orient the reader.",
  description:  "All four Gospels in sequence — Matthew, Mark, Luke, and John — over two months.",
  sections:     {
    1: "MATTHEW",
    19: "MARK",
    28: "LUKE",
