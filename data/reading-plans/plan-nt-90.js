...
const PLAN_NT_90 = [
  ...
  { nt: { ref: "Phlm; Heb 1–2", book: "PHM", ch: 1 }, note: "Receive Onesimus no longer as a slave but as a dear brother · The Son superior to angels; the great High Priest who sympathizes with our weakness" },
...
// ─────────────────────────────────────────────────────────────────────────
const PLAN_NT_90_META = {
  id:           "nt-90",
  globalVar:    "PLAN_NT_90",
  metaVar:      "PLAN_NT_90_META",
  title:        "The New Testament — 90 Days",
  durationLine: "90 days · The New Covenant",
  pdfFilename:  "orthodox-companion-the-new-testament-ninety-days.pdf",
  viewSlug:     "new-testament-ninety-days",
  audience:     ["Catechumen", "The Faithful"],
  summary:      "The entire New Testament in three months. Each day takes one or two chapters; the Gospels, Acts, the Apostolic Epistles, and the Revelation move past at a brisker pace than the year-long plan. Often kept during Great Lent, when the Church reads heavily and listens deeply. Well-suited to the faithful prepared for a sustained, immersive reading, and to catechumens who wish to encounter the whole apostolic preaching before their reception into the Church.",
  description:  "The entire New Testament in three months. Ideal for Great Lent.",
  sections:     {
    1: "MATTHEW",
    11: "MARK",
    17: "LUKE",
