...
// ─────────────────────────────────────────────────────────────────────────
const PLAN_2YEAR_META = {
  id:           "bible-2yr",
  globalVar:    "PLAN_2YEAR",
  metaVar:      "PLAN_2YEAR_META",
  title:        "The Whole Bible — 2 Years",
  durationLine: "730 days · The whole of Holy Scripture",
  pdfFilename:  "orthodox-companion-the-whole-bible-two-years.pdf",
  viewSlug:     "whole-bible-two-years",
  audience:     ["Inquirer", "The Faithful"],
  summary:      "The whole of Holy Scripture, Old Testament and New, read once across two years. Odd-numbered days take an Old Testament passage; even-numbered days carry the day’s Psalms, a few verses of Proverbs, and a chapter of the New Testament. Roughly two to three chapters daily, leaving room to sit with what is read. Well-suited to those approaching Scripture for the first time, and to the faithful who want to walk through the whole canon at the pace of breath rather than haste. Drawn from the Orthodox Study Bible’s two-year reading plan.",
  description:  "The complete Scripture at a gentle pace — ideal for first-time readers.",
  sections:     {}
};
