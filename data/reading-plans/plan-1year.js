...
// ─────────────────────────────────────────────────────────────────────────
const PLAN_1YEAR_META = {
  id:           "bible-1yr",
  globalVar:    "PLAN_1YEAR",
  metaVar:      "PLAN_1YEAR_META",
  title:        "The Whole Bible — 1 Year",
  durationLine: "365 days · The whole of Holy Scripture",
  pdfFilename:  "orthodox-companion-the-whole-bible-one-year.pdf",
  viewSlug:     "whole-bible-one-year",
  audience:     ["The Faithful"],
  summary:      "The full Old and New Testaments, the Psalms, and Proverbs read in one year. Each day carries four passages — one from each — covering the entire Orthodox canon, including the Deuterocanonical books. The pace is steady but not light: roughly four chapters daily across the year. Well-suited to the faithful who want a complete annual reading of the whole Bible alongside the daily Church. Drawn from the Orthodox Christian Daily Bible Reading Plan based on the Orthodox Study Bible.",
  description:  "The complete Old and New Testament in one year. Four passages every day.",
  sections:     {}
};
